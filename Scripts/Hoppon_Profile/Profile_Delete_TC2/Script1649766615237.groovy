...
if (email == GlobalVariable.Username) {
	...
	WebUI.click(findTestObject('Object Repository/Profiles/Page_Edit Profile - Hoppon/button_Delete Account'))
	
	WebUI.comment("Balnk field verification")
	
	WebUI.click(findTestObject('Object Repository/Profiles/Page_Edit Profile - Hoppon/button_Delete AccountConfirm'))
	
	WebUI.comment("Invalid email check")
	
	WebUI.setText(findTestObject('Object Repository/Profiles/Page_Edit Profile - Hoppon/input_Delete Account_email_id_account_delete'), 'abcd@gmail.com')
	
	WebUI.comment("Cancel deletion")
	
	WebUI.click(findTestObject('Object Repository/Profiles/Page_Edit Profile - Hoppon/button_Cancel'))
	
	WebUI.click(findTestObject('Object Repository/Profiles/Page_Edit Profile - Hoppon/button_Delete Account'))
	
	WebUI.comment("Delete account")
	
	WebUI.setText(findTestObject('Object Repository/Profiles/Page_Edit Profile - Hoppon/input_Delete Account_email_id_account_delete'), email)
